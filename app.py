...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.api_key_input.setText("sk-5e08bf1ae16d4e59869481549ff59182")
        ...
        self.app_id_input.setText("ae63ed16d45946e29776c9c5a6eaee49")
    ...
    def start_service(self):
        ...
        listen_list = ['Agent']
        threading.Thread(target=start_wechat_service, args=(api_key, None, "你是一个智能助手，用于回复人们的各种问题", listen_list), daemon=True).start()
